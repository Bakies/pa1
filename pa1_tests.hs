...
<link rel="stylesheet" media="all" href="/assets/application-e0328d1096093e694b761295759ae13e671e1aba0d8cb957120631a3b43472cb.css" />
<link rel="stylesheet" media="print" href="/assets/print-68eed6d8135d858318821e790e25da27b2b4b9b8dbb1993fa6765d8e2e3e16ee.css" />
<script src="/assets/application-c107d379a7736e35098b9fe9be4fb96109d5875334e45894a79acd58a4915c4d.js"></script>
<meta name="csrf-param" content="authenticity_token" />
<meta name="csrf-token" content="ZE4TgtOYv0yn6MXxoW1yUANaW74YUtkc7vlRmjiySwybWPHv36iwq93mRnJ8KdGgXCbo1kLXvTuiO0gwozzLgg==" />
...
<form class="new_user show-gl-field-errors" aria-live="assertive" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="XcQf/lo6buwuQXmB+lq9kNbj7MR5HQ9NhuaYOkG4x5mi0v2TVgphC1RP+gInHh5giZ9frCOYa2rKJIGQ2jZHFw==" /><div class="form-group">
...
<div class="login-body">
<form class="new_new_user show-gl-field-errors" aria-live="assertive" id="new_new_user" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="sCN0RAcZXvq1cHjRhOyU6Qqm9a4hRBErQ5hhUvl/4jdPNZYpCylRHc9++1JZqDcZVdpGxnvBdQwPWnj4YvFiuQ==" /><div class="devise-errors">
...
<input class="form-control middle no-gl-field-error" pattern="[a-zA-Z0-9]+" required="required" title="Please create a username with only alphanumeric characters." type="text" name="new_user[username]" id="new_user_username" />
